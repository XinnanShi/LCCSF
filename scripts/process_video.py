...
from model.LCCSF import LCCSF
from inference.inference_core import InferenceCore
from inference.utils.results_utils import ResultSaver
...
def process_video(cfg: DictConfig):
    ...
    print(f'Loading LCCSF and weights')
    LCCSF = LCCSF(cfg).to(device).eval()
    ...
    processor = InferenceCore(LCCSF, cfg=cfg)
